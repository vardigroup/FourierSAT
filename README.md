...
To achieve better performance, see GradSAT (https://github.com/vardigroup/FourierSAT), an extension of FourierSAT. GradSAT is implemented in C++, where BDDs are used for accelerating gradient computations.**
